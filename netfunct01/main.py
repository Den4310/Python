...
def devicereboot(devicecmd): # devicecmd==dict
    ...
    for ip in devicecmd.keys(): # looping through the dict
        ...
        # we'll learn to write code that connects to devices here
        for my1cmds in devicecmd[ip]:
            print(f'Rebooting {ip}') # fstring
            # Display rebooting ip
    return None
...
def main():
    ...
    print(f"This is the {crayons.green('Network')} Device command pusher")
    ## get data set
